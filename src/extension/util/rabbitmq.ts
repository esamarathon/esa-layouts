...
interface MQEmitter extends EventEmitter {
  ...
  on(event: 'new-screened-crowdcontrolexchange', listener: (data: any) => void): this;
...
const theirTopics = [
  ...
  { name: 'new-screened-crowdcontrolexchange', exchange: 'moderation', key: 'screened.crowdcontrol' },
