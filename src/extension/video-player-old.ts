...
import VideoPlayerShared from '@shared/extension/video-player';
...
const videoPlayerShared = new VideoPlayerShared(
  nodecg(),
  (nodecg().bundleConfig as Configschema).obs,
  obs,
);
...
async function playNext(): Promise<void> {
  try {
    ...
    if (video) {
      ...
      videoPlayerShared.playVideo(video);
    } else {
