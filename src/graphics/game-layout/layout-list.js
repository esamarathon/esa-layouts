...
import L_16x9_2p_CoOp from './16x9-2p-coop.vue';
import L_16x9_2p from './16x9-2p.vue';
import L_16x9_3p from './16x9-3p.vue';
import L_16x9_4p_MonHun from './16x9-4p-monhun.vue';
import L_3DS_1p from './3ds-1p.vue';
import L_4x3_1p from './4x3-1p.vue';
import L_4x3_2p_CoOp from './4x3-2p-coop.vue';
import L_4x3_2p from './4x3-2p.vue';
import L_4x3_3p from './4x3-3p.vue';
import L_4x3_4p_CoOp from './4x3-4p-coop.vue';
import L_4x3_4p from './4x3-4p.vue';
import L_DS_1p from './ds-1p.vue';
import L_GB_1p from './gb-1p.vue';
import L_GBA_1p from './gba-1p.vue';

export { L_4x3_1p, L_4x3_2p, L_4x3_2p_CoOp, L_4x3_3p, L_4x3_4p, L_4x3_4p_CoOp, L_16x9_1p, L_16x9_2p, L_16x9_2p_CoOp, L_16x9_2p_Bingo, L_16x9_3p, L_16x9_4p_MonHun, L_GB_1p, L_GBA_1p, L_3DS_1p, L_DS_1p, };
